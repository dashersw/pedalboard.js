 ...
 */
pb.pot.Log = function(param, name, multiplier, opt_size, opt_min, opt_max, opt_default) {
...
/**
 * @type {function(new: pb.pot.LogModel, (AudioParam|Function), string, number, number=, number=, number=)}
