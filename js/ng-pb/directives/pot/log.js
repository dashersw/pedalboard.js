ngpb.controller('LogPot', ['$rootScope', '$scope', '$element', function($rootScope, $scope, $element) {
    $scope.model = new pb.pot.LogModel($scope.param || $scope.callback(), $scope.name, $scope.multiplier || 1);
    $scope.angle = 260;
...
ngpb.directive('pbLogPot', function() {
    return {
        restrict : 'AE',
        scope: {
            name: '@',
